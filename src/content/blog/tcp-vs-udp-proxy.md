...
2.  **UDP 是“困难户”**：要代理 UDP，不仅需要客户端支持（如开启 [TUN 模式](/blog/what-is-tun-mode)），还需要目标[节点](/blog/what-is-node/)服务商的底层防火墙予以放行。由于 UDP 无连接的特性，它极易被黑客用来进行 DDoS 放大攻击或进行无休止的 BT 下载，因此很多服务商会在服务端直接屏蔽所有的 UDP 请求。
